  ...
  if (_result.isPar3) {
    ...
    const par3Card = (() => {
      ...
      if (!teeMarked) {
        ...
        bagSvg.setAttribute('width','18'); bagSvg.setAttribute('height','18');
        bagSvg.setAttribute('viewBox','0 0 496 496'); bagSvg.setAttribute('fill','currentColor');
        bagSvg.style.color = par3Override() ? '#1a1a1a' : '#888';
        bagSvg.innerHTML = `<g><g><g><rect x="336" y="264" width="16" height="16"/><path d="M402.752,0h-53.504C333.12,0,320,13.12,320,29.248c0,0.936,0.168,1.832,0.256,2.752H320v64H208V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C290.88,64,304,50.88,304,34.752v-5.504C304,13.12,290.88,0,274.752,0h-53.504C205.12,0,192,13.12,192,29.248c0,0.936,0.168,1.832,0.256,2.752H192v64h-16V32h-0.256c0.088-0.92,0.256-1.816,0.256-2.752C176,13.12,162.88,0,146.752,0H93.248C77.12,0,64,13.12,64,29.248v5.504C64,50.88,77.12,64,93.248,64h9.432c1.216,0,2.424-0.072,3.632-0.224l44.08-5.504c3.44-0.44,6.664-1.504,9.608-3.008V96h-8c-10.608,0-19.528,6.96-22.688,16.52C106.008,115.792,88,135.808,88,160v232c0,23.736,17.336,43.448,40,47.28V440c0,10.416,6.712,19.216,16,22.528V496h192v-33.472c9.288-3.312,16-12.112,16-22.528v-64h8c13.232,0,24-10.768,24-24V184h-32v-64c0-10.416-6.712-19.216-16-22.528V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C418.88,64,432,50.88,432,34.752v-5.504C432,13.12,418.88,0,402.752,0z M221.248,16h53.504C282.056,16,288,21.944,288,29.248v5.504C288,42.056,282.056,48,274.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L219.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C208,21.944,213.944,16,221.248,16z M128,422.864c-13.76-3.576-24-16-24-30.864V160c0-14.864,10.24-27.288,24-30.864V422.864z M148.392,42.392l-44.072,5.504c-0.544,0.072-1.096,0.104-1.648,0.104H93.24C85.944,48,80,42.056,80,34.752v-5.504C80,21.944,85.944,16,93.248,16h53.504C154.056,16,160,21.944,160,29.248C160,35.912,155.008,41.56,148.392,42.392z M144,120c0-4.408,3.592-8,8-8h176c4.408,0,8,3.592,8,8v24H144V120z M320,480H160v-16h160V480z M336,440c0,4.408-3.592,8-8,8H152c-4.408,0-8-3.592-8-8V160h192v24h-32v168c0,13.232,10.768,24,24,24h8V440z M368,352c0,4.408-3.592,8-8,8h-32c-4.408,0-8-3.592-8-8V248h48V352z M368,200v32h-48v-32H368z M416,34.752C416,42.056,410.056,48,402.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L347.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C336,21.944,341.944,16,349.248,16h53.504C410.056,16,416,21.944,416,29.248V34.752z"/><rect x="304" y="416" width="16" height="16"/><rect x="272" y="416" width="16" height="16"/><rect x="240" y="416" width="16" height="16"/></g></g></g>`;
  ...
  function buildStrategyCard(basePlan, cardIndex, totalCards, detailOpen) {
      ...
      if (isDone) {
        ...
        if (i === 1 && !isDone) {
          ...
          if (shot2Candidates.length > 0) {
            ...
            s2BagSvg.setAttribute('width', '18'); s2BagSvg.setAttribute('height', '18');
            s2BagSvg.setAttribute('viewBox', '0 0 496 496'); s2BagSvg.setAttribute('fill', 'currentColor');
            s2BagSvg.style.color = '#888';
            s2BagSvg.innerHTML = '<g><g><g><rect x="336" y="264" width="16" height="16"/><path d="M402.752,0h-53.504C333.12,0,320,13.12,320,29.248c0,0.936,0.168,1.832,0.256,2.752H320v64H208V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C290.88,64,304,50.88,304,34.752v-5.504C304,13.12,290.88,0,274.752,0h-53.504C205.12,0,192,13.12,192,29.248c0,0.936,0.168,1.832,0.256,2.752H192v64h-16V32h-0.256c0.088-0.92,0.256-1.816,0.256-2.752C176,13.12,162.88,0,146.752,0H93.248C77.12,0,64,13.12,64,29.248v5.504C64,50.88,77.12,64,93.248,64h9.432c1.216,0,2.424-0.072,3.632-0.224l44.08-5.504c3.44-0.44,6.664-1.504,9.608-3.008V96h-8c-10.608,0-19.528,6.96-22.688,16.52C106.008,115.792,88,135.808,88,160v232c0,23.736,17.336,43.448,40,47.28V440c0,10.416,6.712,19.216,16,22.528V496h192v-33.472c9.288-3.312,16-12.112,16-22.528v-64h8c13.232,0,24-10.768,24-24V184h-32v-64c0-10.416-6.712-19.216-16-22.528V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C418.88,64,432,50.88,432,34.752v-5.504C432,13.12,418.88,0,402.752,0z M221.248,16h53.504C282.056,16,288,21.944,288,29.248v5.504C288,42.056,282.056,48,274.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L219.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C208,21.944,213.944,16,221.248,16z M128,422.864c-13.76-3.576-24-16-24-30.864V160c0-14.864,10.24-27.288,24-30.864V422.864z M148.392,42.392l-44.072,5.504c-0.544,0.072-1.096,0.104-1.648,0.104H93.24C85.944,48,80,42.056,80,34.752v-5.504C80,21.944,85.944,16,93.248,16h53.504C154.056,16,160,21.944,160,29.248C160,35.912,155.008,41.56,148.392,42.392z M144,120c0-4.408,3.592-8,8-8h176c4.408,0,8,3.592,8,8v24H144V120z M320,480H160v-16h160V480z M336,440c0,4.408-3.592,8-8,8H152c-4.408,0-8-3.592-8-8V160h192v24h-32v168c0,13.232,10.768,24,24,24h8V440z M368,352c0,4.408-3.592,8-8,8h-32c-4.408,0-8-3.592-8-8V248h48V352z M368,200v32h-48v-32H368z M416,34.752C416,42.056,410.056,48,402.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L347.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C336,21.944,341.944,16,349.248,16h53.504C410.056,16,416,21.944,416,29.248V34.752z"/><rect x="304" y="416" width="16" height="16"/><rect x="272" y="416" width="16" height="16"/><rect x="240" y="416" width="16" height="16"/></g></g></g>';
    ...
    if (activePlan.shots.length === 1 && !teeMarked) {
      ...
      if (appCandidates.length > 0) {
        ...
        appBagSvg.setAttribute('width', '18'); appBagSvg.setAttribute('height', '18');
        appBagSvg.setAttribute('viewBox', '0 0 496 496'); appBagSvg.setAttribute('fill', 'currentColor');
        appBagSvg.style.color = '#888';
        appBagSvg.innerHTML = '<g><g><g><rect x="336" y="264" width="16" height="16"/><path d="M402.752,0h-53.504C333.12,0,320,13.12,320,29.248c0,0.936,0.168,1.832,0.256,2.752H320v64H208V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C290.88,64,304,50.88,304,34.752v-5.504C304,13.12,290.88,0,274.752,0h-53.504C205.12,0,192,13.12,192,29.248c0,0.936,0.168,1.832,0.256,2.752H192v64h-16V32h-0.256c0.088-0.92,0.256-1.816,0.256-2.752C176,13.12,162.88,0,146.752,0H93.248C77.12,0,64,13.12,64,29.248v5.504C64,50.88,77.12,64,93.248,64h9.432c1.216,0,2.424-0.072,3.632-0.224l44.08-5.504c3.44-0.44,6.664-1.504,9.608-3.008V96h-8c-10.608,0-19.528,6.96-22.688,16.52C106.008,115.792,88,135.808,88,160v232c0,23.736,17.336,43.448,40,47.28V440c0,10.416,6.712,19.216,16,22.528V496h192v-33.472c9.288-3.312,16-12.112,16-22.528v-64h8c13.232,0,24-10.768,24-24V184h-32v-64c0-10.416-6.712-19.216-16-22.528V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C418.88,64,432,50.88,432,34.752v-5.504C432,13.12,418.88,0,402.752,0z M221.248,16h53.504C282.056,16,288,21.944,288,29.248v5.504C288,42.056,282.056,48,274.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L219.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C208,21.944,213.944,16,221.248,16z M128,422.864c-13.76-3.576-24-16-24-30.864V160c0-14.864,10.24-27.288,24-30.864V422.864z M148.392,42.392l-44.072,5.504c-0.544,0.072-1.096,0.104-1.648,0.104H93.24C85.944,48,80,42.056,80,34.752v-5.504C80,21.944,85.944,16,93.248,16h53.504C154.056,16,160,21.944,160,29.248C160,35.912,155.008,41.56,148.392,42.392z M144,120c0-4.408,3.592-8,8-8h176c4.408,0,8,3.592,8,8v24H144V120z M320,480H160v-16h160V480z M336,440c0,4.408-3.592,8-8,8H152c-4.408,0-8-3.592-8-8V160h192v24h-32v168c0,13.232,10.768,24,24,24h8V440z M368,352c0,4.408-3.592,8-8,8h-32c-4.408,0-8-3.592-8-8V248h48V352z M368,200v32h-48v-32H368z M416,34.752C416,42.056,410.056,48,402.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L347.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C336,21.944,341.944,16,349.248,16h53.504C410.056,16,416,21.944,416,29.248V34.752z"/><rect x="304" y="416" width="16" height="16"/><rect x="272" y="416" width="16" height="16"/><rect x="240" y="416" width="16" height="16"/></g></g></g>';
      ...
      gpsContinuation.shots.forEach((s, i) => {
        ...
        if (i === 0) {
          ...
          if (chipCands.length > 0) {
            ...
            const bagSvg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
            bagSvg.setAttribute('width', '18'); bagSvg.setAttribute('height', '18'); bagSvg.setAttribute('viewBox', '0 0 496 496'); bagSvg.setAttribute('fill', 'currentColor'); bagSvg.style.color = '#888';
            bagSvg.innerHTML = '<g><g><g><rect x="336" y="264" width="16" height="16"/><path d="M402.752,0h-53.504C333.12,0,320,13.12,320,29.248c0,0.936,0.168,1.832,0.256,2.752H320v64H208V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C290.88,64,304,50.88,304,34.752v-5.504C304,13.12,290.88,0,274.752,0h-53.504C205.12,0,192,13.12,192,29.248c0,0.936,0.168,1.832,0.256,2.752H192v64h-16V32h-0.256c0.088-0.92,0.256-1.816,0.256-2.752C176,13.12,162.88,0,146.752,0H93.248C77.12,0,64,13.12,64,29.248v5.504C64,50.88,77.12,64,93.248,64h9.432c1.216,0,2.424-0.072,3.632-0.224l44.08-5.504c3.44-0.44,6.664-1.504,9.608-3.008V96h-8c-10.608,0-19.528,6.96-22.688,16.52C106.008,115.792,88,135.808,88,160v232c0,23.736,17.336,43.448,40,47.28V440c0,10.416,6.712,19.216,16,22.528V496h192v-33.472c9.288-3.312,16-12.112,16-22.528v-64h8c13.232,0,24-10.768,24-24V184h-32v-64c0-10.416-6.712-19.216-16-22.528V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C418.88,64,432,50.88,432,34.752v-5.504C432,13.12,418.88,0,402.752,0z M221.248,16h53.504C282.056,16,288,21.944,288,29.248v5.504C288,42.056,282.056,48,274.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L219.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C208,21.944,213.944,16,221.248,16z M128,422.864c-13.76-3.576-24-16-24-30.864V160c0-14.864,10.24-27.288,24-30.864V422.864z M148.392,42.392l-44.072,5.504c-0.544,0.072-1.096,0.104-1.648,0.104H93.24C85.944,48,80,42.056,80,34.752v-5.504C80,21.944,85.944,16,93.248,16h53.504C154.056,16,160,21.944,160,29.248C160,35.912,155.008,41.56,148.392,42.392z M144,120c0-4.408,3.592-8,8-8h176c4.408,0,8,3.592,8,8v24H144V120z M320,480H160v-16h160V480z M336,440c0,4.408-3.592,8-8,8H152c-4.408,0-8-3.592-8-8V160h192v24h-32v168c0,13.232,10.768,24,24,24h8V440z M368,352c0,4.408-3.592,8-8,8h-32c-4.408,0-8-3.592-8-8V248h48V352z M368,200v32h-48v-32H368z M416,34.752C416,42.056,410.056,48,402.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L347.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C336,21.944,341.944,16,349.248,16h53.504C410.056,16,416,21.944,416,29.248V34.752z"/><rect x="304" y="416" width="16" height="16"/><rect x="272" y="416" width="16" height="16"/><rect x="240" y="416" width="16" height="16"/></g></g></g>';
    ...
    if (!teeMarked) {
      ...
      bagBtnSvg.setAttribute('viewBox', '0 0 496 496'); bagBtnSvg.setAttribute('fill', 'currentColor');
      bagBtnSvg.style.color = override ? 'inherit' : '#888';
      bagBtnSvg.innerHTML = '<g><g><g><rect x="336" y="264" width="16" height="16"/><path d="M402.752,0h-53.504C333.12,0,320,13.12,320,29.248c0,0.936,0.168,1.832,0.256,2.752H320v64H208V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C290.88,64,304,50.88,304,34.752v-5.504C304,13.12,290.88,0,274.752,0h-53.504C205.12,0,192,13.12,192,29.248c0,0.936,0.168,1.832,0.256,2.752H192v64h-16V32h-0.256c0.088-0.92,0.256-1.816,0.256-2.752C176,13.12,162.88,0,146.752,0H93.248C77.12,0,64,13.12,64,29.248v5.504C64,50.88,77.12,64,93.248,64h9.432c1.216,0,2.424-0.072,3.632-0.224l44.08-5.504c3.44-0.44,6.664-1.504,9.608-3.008V96h-8c-10.608,0-19.528,6.96-22.688,16.52C106.008,115.792,88,135.808,88,160v232c0,23.736,17.336,43.448,40,47.28V440c0,10.416,6.712,19.216,16,22.528V496h192v-33.472c9.288-3.312,16-12.112,16-22.528v-64h8c13.232,0,24-10.768,24-24V184h-32v-64c0-10.416-6.712-19.216-16-22.528V55.264c2.944,1.504,6.168,2.576,9.616,3l44.08,5.504c1.2,0.16,2.416,0.232,3.632,0.232h9.432C418.88,64,432,50.88,432,34.752v-5.504C432,13.12,418.88,0,402.752,0z M221.248,16h53.504C282.056,16,288,21.944,288,29.248v5.504C288,42.056,282.056,48,274.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L219.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C208,21.944,213.944,16,221.248,16z M128,422.864c-13.76-3.576-24-16-24-30.864V160c0-14.864,10.24-27.288,24-30.864V422.864z M148.392,42.392l-44.072,5.504c-0.544,0.072-1.096,0.104-1.648,0.104H93.24C85.944,48,80,42.056,80,34.752v-5.504C80,21.944,85.944,16,93.248,16h53.504C154.056,16,160,21.944,160,29.248C160,35.912,155.008,41.56,148.392,42.392z M144,120c0-4.408,3.592-8,8-8h176c4.408,0,8,3.592,8,8v24H144V120z M320,480H160v-16h160V480z M336,440c0,4.408-3.592,8-8,8H152c-4.408,0-8-3.592-8-8V160h192v24h-32v168c0,13.232,10.768,24,24,24h8V440z M368,352c0,4.408-3.592,8-8,8h-32c-4.408,0-8-3.592-8-8V248h48V352z M368,200v32h-48v-32H368z M416,34.752C416,42.056,410.056,48,402.752,48h-9.432c-0.552,0-1.096-0.032-1.648-0.104L347.6,42.392c-6.608-0.832-11.6-6.48-11.6-13.144C336,21.944,341.944,16,349.248,16h53.504C410.056,16,416,21.944,416,29.248V34.752z"/><rect x="304" y="416" width="16" height="16"/><rect x="272" y="416" width="16" height="16"/><rect x="240" y="416" width="16" height="16"/></g></g></g>';
