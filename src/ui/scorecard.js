...
export function renderPlayCourseBar(courseId, callbacks = {}) {
  ...
  function updateBar() {
    ...
    dismissBtn.innerHTML = '<svg width="18" height="18" viewBox="-2.000 -74.459 84.860 80.459" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M64.4043-64.7461L10.8887-11.2305C9.42383-9.76562 9.375-7.17773 10.8887-5.66406C12.4512-4.15039 14.9902-4.15039 16.5039-5.66406L69.9707-59.1309C71.4844-60.6445 71.5332-63.2324 69.9707-64.7461C68.4082-66.2109 65.918-66.2598 64.4043-64.7461ZM69.9707-11.2305L16.5039-64.7461C14.9902-66.2109 12.4023-66.2598 10.8887-64.7461C9.42383-63.1836 9.42383-60.6445 10.8887-59.1309L64.4043-5.66406C65.8691-4.15039 68.457-4.15039 69.9707-5.66406C71.4844-7.22656 71.4844-9.76562 69.9707-11.2305Z"/></svg>';
  ...
  function renderSummary() {
    ...
    played.forEach(h => {
      if (h.total != null) {
        ...
        if (h.par >= 4) { totalFIRDenom++; if (h.fir === true) totalFIR++; }
        holesPlayed++;
      }
    });
    ...
    let runAcc = 0;
    const runningTotals = played.map(h => {
      if (h.total == null) return null;
      runAcc += h.total - h.par;
      return runAcc;
    });
    ...
    if (holesPlayed > 0) {
      ...
      saveBtn.className = 'sc2-save-btn';
      saveBtn.type = 'button';
